  ...
  <div class="">
    <div class="flex justify-between align-middle">
      <div class="flex flex-col justify-start">
        <img class="mt-5 ml-5 w-16 h-18" src="../assets/logo.svg" alt="Logotipo" />
      </div>
      <ul
      ...
      >
        ...
        >
          <a href="#" class="rounded-full border-4 px-3 py-1 border-resaltar"
            :class="{ 'bg-resaltar': isActive('Cesta') }"
            >1</a>
          <p class="mx-2">Cesta</p>
        </li>

        <li
          class="flex justify-center items-center font-barlow hover:text-gray-200 cursor-pointer"
        >
          <span class="w-10 h-1 bg-primary" :class="{ 'bg-resaltar' : isActive('pago')}"></span>
          <a href="#" class="rounded-full border-4 px-3 py-1 border-primary"
            :class="{ 'bg-resaltar': isActive('Pago') }">2</a>
          <p class="mx-2">Pago</p>
        </li>
        <li
          class="flex justify-center items-center font-barlow hover:text-gray-200 cursor-pointer"
        >
            <span class="w-10 h-1 bg-primary" :class="{ 'bg-resaltar' : isActive('pago')}"></span>
          <a href="#" class="rounded-full border-4 px-3 py-1 border-primary"
            :class="{ 'bg-resaltar': isActive('activar_juego') }"
            >3</a>
          <p class="mx-2">Activar Juego</p>
        </li>
      </ul>
